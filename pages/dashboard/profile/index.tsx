...
const ChangePasswordComponent = () => {
  ...
  const [showPlainPassword3, setShowPlainPassword3] = useState(false);
  ...
  return (
    <div className="flex w-[390px] md:w-[475px] flex-col rounded-md dark:bg-darkmain bg-white m-1 md:m-5">
      ...
      <div className="flex flex-col mt-0 relative">
        <label htmlFor="password" className="mb-0 ml-3">
          Old Password
        </label>
      <input
        value={oldPassword}
      ...
      <input
       type={`${showPlainPassword3 ? "text" : "password"}`}
        value={confirmNew}
      ...
      />
          <div
          onClick={() => setShowPlainPassword3(!showPlainPassword3)}
          className="absolute top-8 right-3 cursor-pointer"
        >
          {showPlainPassword3 ? (
            <svg

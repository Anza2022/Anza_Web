...
const AdminAddWorkSchemePage = () => {
  ...
  const handleSavePaper = async () => {
    ...
    try {
      let newscheme = new SchemeOfWorkModel(
        "",
        title,
        fileId,
      ...
      let res = await WorkSchemesRepo.addSchemesOfWork(newscheme);
      setSchemesOfWork([res, ...schemesOfWork]);
        ...
        <div className="flex flex-col  items-center w-full">
          ...
          <div className="w-full mt-5 flex flex-wrap justify-around">
            ...
            >
              ...
              <p> {savingPaper ? "saving scheme ..." : "Save Work Scheme"}</p>
...
export default AdminAddWorkSchemePage;

...
const NavbarComponent = () => {
  ...
  return (
    ...
    <p className="text-s font-normal pointer-cursor"> 33.3% (Kes. 1,000) OFF!  Limited offer till Dec. 5th, 2022 was<span className="line-through text-red-500 font-bold"> KSH 3000</span> now <span className="text-green-500 font-bold" >KSH 2000 </span>    <a 
     onClick={() => {

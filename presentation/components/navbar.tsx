  ...
  return (
    <div className="w-full h-12 md:h-16  bg-indigo-800 dark:bg-darkmain  flex  justify-between px-5 items-center shadow-xl hover:shadow-2xl fixed top-0 left-0 z-20 ">
      ...
      <div className="flex items-center space-x-2 ">
        ...
        <div className="flex flex-nowrap hidden md:flex py-1 text-base md:mt-7 ml-20 text-white" >
    <p className="text-s font-normal pointer-cursor"> <marquee> 33.3% (Kes. 1,000) OFF!  Limited offer till Dec. 5th, 2022 was<span className="line-through text-red-500 font-bold"> KSH 3000</span> now <span className="text-green-500 font-bold" >KSH 2000 </span>    <a 
     onClick={() => {
